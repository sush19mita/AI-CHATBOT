...
// API setup
const API_KEY = "AIzaSyCohapy3RrXV647yummktvfyCLOFJQTAkE";
...
const picker = new EmojiMart.Picker({
    ...
    onEmojiSelect: (emoji) => {
        ...
        const emojiChar = emoji.native || emoji.emoji; // Compatibility fallback
        const { selectionStart: start, selectionEnd: end } = messageInput;
        messageInput.setRangeText(emojiChar, start, end, "end");
        messageInput.focus();
    },
    onClickOutside: (e) => {
